  ...
  return (
    ...
    >
      <div className="flex flex-col items-center">
        ...
        >
          <span className="font-mono text-[11px]" style={{ color: "oklch(0.65 0 0)" }}>
            {step.num}
          </span>
        </div>
        {index < total - 1 && (
      ...
      <div className="pb-2">
        <p className="font-mono text-[9px] uppercase tracking-wider mb-2" style={{ color: "oklch(0.38 0 0)" }}>
          {step.label}
        </p>
        <h3
        ...
        <p className="font-sora font-light text-sm leading-relaxed" style={{ color: "oklch(0.38 0 0)" }}>
          {step.desc}
        </p>
      </div>
    </motion.div>
